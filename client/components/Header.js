  ...
  return (
    <header className='sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md p-5 md:px-10'>
      ...
      <div className='flex items-center space-x-4 justify-end'>
        <p className='hidden md:inline md:cursor-pointer'>Become a host</p>
        <GlobeAltIcon className='h-6 cursor-pointer pr-4' />
        <div className='flex items-center space-x-2 border-2 p-2 rounded-full'>
          <MenuIcon className='h-6 cursor-pointer' />
          <UserCircleIcon className='h-6 cusor-point' />
        </div>
      ...
      {searchInput && (
        <div className='flex flex-col col-span-3 mx-auto'>
          ...
          <div className='flex items-center border-b mb-4'>
            <h2 className='flex-grow text-2xl pl-4 font-semibold'>Number of Guests</h2>
